...
def porticosSucessivos(
    n_andares=20, n_pilares_por_andar=7, distancia_pilares=6, pe_direito=3
):
    """PORTICOS SUCESSIVOS"""
    ...
    for qtpilares in range(1, n_pilares_por_andar, 1):
        for i in range(1, n_andares, 1):
            elements.append(
                Element(
                    nodes[i + (qtpilares - 1) * n_andares],
                    nodes[i + qtpilares * n_andares],
                    area_v,
                    inercia_v,
                    young_modulus,
                )
...
def process_simulation(
    ...
    try:
        erros: list[str] = []
        time = None
        proc = Process(structure.nodes, structure.elements, Analise.viaRigidezAnalitica)
...
if __name__ == "__main__":
    uvatool_text = """                                                                                                                          
888     888 888     888        d8888 88888888888                   888 
888     888 888     888       d88888     888                       888 
888     888 888     888      d88P888     888                       888 
888     888 Y88b   d88P     d88P 888     888      .d88b.   .d88b.  888 
888     888  Y88b d88P     d88P  888     888     d88""88b d88""88b 888 
888     888   Y88o88P     d88P   888     888     888  888 888  888 888 
Y88b. .d88P    Y888P     d8888888888     888     Y88..88P Y88..88P 888 
 "Y88888P"      Y8P     d88P     888     888      "Y88P"   "Y88P"  888
 """
    print(uvatool_text)
