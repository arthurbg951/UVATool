...
from PyQt5.QtCore import Qt, QPointF, QLineF, QEvent, QObject, QThread, pyqtSignal
...
from uvatool_gui.forms.TableResults import FormTableResults
...
class FormUVATool(QMainWindow):
    ...
    def __init__(self):
        ...
        uic.loadUi(
            os.path.join(os.path.dirname(__file__), "..", "ui", "FormUVATool.ui"), self
        )
    ...
    def loadStructureFile(self) -> None:
        ...
        response = QFileDialog.getOpenFileName(
            ...
            directory=f"{os.getcwd()}/exemples",
            filter=file_filter,
        ...
        try:
            if file_name != "":
                ...
                if len(file.getStructure()) > 1:
                    raise Exception(
                        "This file contains multiple structures.\nTry another file or edit source code."
                    )
