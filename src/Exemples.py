...
try:
    ...
    e2 = Element(n2, n4, area, momento_inercia, 1)
    e3 = Element(n3, n4, area, momento_inercia, 1)
    e4 = Element(n3, n5, area, momento_inercia, 1)
    e5 = Element(n4, n6, area, momento_inercia, 1)
    e6 = Element(n5, n6, area, momento_inercia, 1)
    e7 = Element(n5, n7, area, momento_inercia, 1)
    e8 = Element(n6, n8, area, momento_inercia, 1)
    e9 = Element(n7, n8, area, momento_inercia, 1)
